      ...
      <>
        ...
        <div className="install viewport" id="install">
          <div className="install-info">
            ...
            <img className="install-gif" src="img/llm-d-logo.svg" alt="llm-d"></img>
            <h2 className="install-h2">It's as easy as 1...2...llm-d!</h2>
  
            {/* ----------- Modular Section (copy and paste as many as needed) ---------- */}
            <h3 className="install-h3"><a className="link" href="docs/guide/installation/Prerequisites">1. Check the Prerequisites</a></h3>
            <h3 className="install-h3"><a className="link" href="docs/guide/installation/quickstart">2. Run the Quickstart</a></h3>
