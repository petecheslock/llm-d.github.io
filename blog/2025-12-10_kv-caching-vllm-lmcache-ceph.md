...
![Supermicro X14 2U 4-node GrandTwin Rear IO](/img/blogs/kv-caching-ceph/smci-x14-grandtwin.png)
...
![Supermicro Gaudi 3 AI Server SYS-822GA-NGR3](/img/blogs/kv-caching-ceph/smci-gaudi3.png)
...
![Supermicro GPU A+ Server AS-8125GS-TNMR2](/img/blogs/kv-caching-ceph/smci-gpu-aplus.png)
...
![SSE-T7132S - 400Gb Ethernet Switch](/img/blogs/kv-caching-ceph/smci-sw.png)
...
![elbencho baseline performance](/img/blogs/kv-caching-ceph/elbencho.png)
...
![AMD TP1 Sweep](/img/blogs/kv-caching-ceph/amd-tp1-sweep.png)

![AMD TP Qwen](/img/blogs/kv-caching-ceph/amd-tp-qwen.png)

![AMD TP Llama](/img/blogs/kv-caching-ceph/amd-tp-llama.png)
...
Considerable reduction in TTFT with both Intel Gaudi3 and AMD MI300X
...
spread prefill across multiple GPUs in a system and that combining these
...
We shared our results with the llm-d team at Red Hat and have started to work
